...
if ($mode !== 'Inactive' && !$vlan) { echo json_encode(['success'=>false,'message'=>'Pilih VLAN management terlebih dahulu. Tandai VLAN bertipe management di OLT Settings jika belum ada.']); exit; }
